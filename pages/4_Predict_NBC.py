...
vectorizer_pkl  = config.DS_vector
...
if uploaded_file is not None:
    ...
    with open(config.MODEL_nbc, "rb") as f:
    ...
    try:
        ...
        X_train = pd.read_hdf(config.DS_finalframe_h5, key='X_train')
        raw_train_df = pd.read_pickle(config.DS_finalframe)
